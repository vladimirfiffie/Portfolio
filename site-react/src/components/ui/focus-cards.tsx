...
export function FocusCards({ cards }: { cards: CardType[] }) {
  ...
  return (
    <div className="relative w-screen left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] overflow-hidden py-6 sm:py-10 bg-background">
      <div
        ref={trackRef}
        ...
        {infiniteCards.map((card, index) => (
          <a
            ...
            className={cn(
              ...
              // Fluid card widths via CSS clamp so they scale between mobile and desktop
