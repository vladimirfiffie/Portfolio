...
const Footer = () => {
  ...
  const coreStack = ["React", "Next.js", "TypeScript", "Tailwind", "Framer Motion"];
  ...
  return (
    <footer className="relative w-full bg-neutral-950 pt-24 pb-12 overflow-hidden">
      ...
      <div className="absolute top-0 left-1/4 w-1/2 h-[1px] bg-gradient-to-r from-transparent via-blue-500/40 to-transparent blur-md" />
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-8">
        ...
        <div className="mt-20 pt-8 border-t border-neutral-900/50 relative flex flex-col items-center justify-center gap-4">
