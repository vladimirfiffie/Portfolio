      ...
      content: (
        <div>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <ProjectCard title="Lion's Den Cinema" color="from-purple-500/20 to-pink-500/20" borderColor="border-purple-500/50" />
            <ProjectCard title="React & TypeScript" color="from-emerald-500/20 to-teal-500/20" borderColor="border-emerald-500/50" />
            <ProjectCard title="Full Stack Dev" color="from-orange-500/20 to-red-500/20" borderColor="border-orange-500/50" />
          </div>
        </div>
      ),
    },
    ...
    },
    {
      ...
      content: (
        <div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <ProjectCard title="Backend Dev" color="from-green-500/20 to-emerald-500/20" borderColor="border-green-500/50" />
            <ProjectCard title="Databases" color="from-yellow-500/20 to-amber-500/20" borderColor="border-yellow-500/50" />
            <ProjectCard title="API Design" color="from-red-500/20 to-orange-500/20" borderColor="border-red-500/50" />
            <ProjectCard title="Growth" color="from-fuchsia-500/20 to-purple-500/20" borderColor="border-fuchsia-500/50" />
          </div>
        </div>
      ),
    },
...
function ProjectCard({ title, color, borderColor }: { title: string; color: string; borderColor: string }) {
  return (
    <div className={`h-20 md:h-44 lg:h-60 rounded-lg bg-gradient-to-br ${color} border ${borderColor} flex items-center justify-center`}>
      <span className="text-xs md:text-sm text-neutral-800 dark:text-white font-semibold text-center px-2">{title}</span>
    </div>
  );
}